...
public:
    ...
    virtual char* getHotKeyTitle_selectLoop() { return NULL; };
    ...
    virtual char* getHotKeyTitle_showSelectedNodeText() { return NULL; };
    ...
    virtual char* getHotKeyTitle_FixedXCoordOfSelected() { return NULL; };
    virtual char* getHotKeyTitle_unFixedXCoordOfSelected() { return NULL; };
    virtual char* getHotKeyTitle_unFixedXCoordOfAllNode() { return NULL; };
    ...
    virtual char* getHotKeyTitle_ShowAndHideBoundFrame() { return NULL; };
...
private:
    ...
    string hotKeyTitle_selectLoop = "选择环";
    ...
    string hotKeyTitle_showSelectedNodeText = "显示选中节点的文本";
    ...
    string hotKeyTitle_unFixedPositionOfAllNode = "取消固定未选中的节点的位置";
    string hotKeyTitle_FixedXCoordOfSelected = "固定选中的节点的x坐标";
    string hotKeyTitle_unFixedXCoordOfSelected = "取消固定选中的节点的x坐标";
    string hotKeyTitle_unFixedXCoordOfAllNode = "取消固定未选中的节点的x坐标";
    ...
    string hotKeyTitle_unGroupAllNode = "取消聚合未选中的节点";
    ...
    string hotKeyTitle_ClearAllNodeColor = "清除未选中的节点颜色";
    string hotKeyTitle_ShowAndHideTooltip = "显示隐藏节点详细信息";
    string hotKeyTitle_ShowAndHideBoundFrame = "显示隐藏节点的位置边界";
...
public:
    ...
    char* getHotKeyTitle_selectLoop() override;
    ...
    char* getHotKeyTitle_showSelectedNodeText() override;
    ...
    char* getHotKeyTitle_FixedXCoordOfSelected() override;
    char* getHotKeyTitle_unFixedXCoordOfSelected() override;
    char* getHotKeyTitle_unFixedXCoordOfAllNode() override;
    ...
    char* getHotKeyTitle_ShowAndHideBoundFrame() override;
