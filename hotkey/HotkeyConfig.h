...
enum HotkeyFunction {
    SHOW_EDIT_HOTKEY,
    CHOOOSE_CLASS_SCOPE,
    UNCHOOOSE_CLASS_SCOPE,
    CHOOSE_LINE_INSTANCE_TO_SEARCH,
    UNCHOOSE_LINE_INSTANCE_TO_SEARCH,
    CHOOSE_GRAPH_INSTANCE_TO_SEARCH,
    UNCHOOSE_GRAPH_INSTANCE_TO_SEARCH,
    START_SEARCHING,
    ...
    REMOVE_ALL_NODES,
    SELECT_UPWARD,
    SELECT_UPWARD_TO_THE_TOP,
    SELECT_DOWNWARD,
    SELECT_DOWNWARD_TO_THE_BOTTOM,
    REVERSE_SELECT,
    SELECT_LOOP,
    SELECT_PATH_IN_BETWEEN,
    SELECT_SHORTEST_PATH_IN_BETWEEN,
    SELECT_PATH_UPWARD,
