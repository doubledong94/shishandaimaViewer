...
public:
  enum {
    ...
    RETURN = 70, CALLED_RETURN = 71, INDEX = 72, ERROR = 73, SEGMENT = 74, 
    LINE = 75, LINE_INSTANCE = 76, GLUE = 77, GLUE_RUNTIME = 78, GLULE_MEMBER_OF = 79, 
    GLUE_INSTANCE_OF = 80, GLUE_OVERRIDE = 81, GLUE_HIERARCHY = 82, GRAPH = 83, 
    GRAPH_INSTANCE = 84, CODE_ORDER = 85, SHOW = 86, STRING = 87, IDENTIFIER = 88, 
    FLOAT = 89, INT = 90, WS = 91, LINE_COMMENT = 92
  };
