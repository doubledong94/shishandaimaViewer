...
public:
  enum {
    ...
    LINE_INSTANCE = 80, GLUE = 81, GLUE_RUNTIME = 82, GLULE_MEMBER_OF = 83, 
    GLUE_INSTANCE_OF = 84, GLUE_OVERRIDE = 85, GLUE_HIERARCHY = 86, GRAPH = 87, 
    GRAPH_INSTANCE = 88, CODE_ORDER = 89, SHOW = 90, STRING = 91, IDENTIFIER = 92, 
    FLOAT = 93, INT = 94, WS = 95, LINE_COMMENT = 96
  };
