...
public:
  enum {
    ...
    CLASS_SCOPE = 52, NODE = 53, REFERENCE = 54, CONDITION = 55, STEP = 56, 
    SEGMENT = 57, LINE = 58, LINE_INSTANCE = 59, GLUE = 60, GLUE_RUNTIME = 61, 
    GLULE_MEMBER_OF = 62, GLUE_INSTANCE_OF = 63, GLUE_OVERRIDE = 64, GLUE_HIERARCHY = 65, 
    GRAPH = 66, GRAPH_INSTANCE = 67, CODE_ORDER = 68, SHOW = 69, STRING = 70, 
    IDENTIFIER = 71, FLOAT = 72, INT = 73, WS = 74, LINE_COMMENT = 75
  };
