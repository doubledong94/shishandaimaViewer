...
public:
  enum {
    ...
    CALLED_RETURN = 66, INDEX = 67, SEGMENT = 68, LINE = 69, LINE_INSTANCE = 70, 
    GLUE = 71, GLUE_RUNTIME = 72, GLULE_MEMBER_OF = 73, GLUE_INSTANCE_OF = 74, 
    GLUE_OVERRIDE = 75, GLUE_HIERARCHY = 76, GRAPH = 77, GRAPH_INSTANCE = 78, 
    CODE_ORDER = 79, SHOW = 80, STRING = 81, IDENTIFIER = 82, FLOAT = 83, 
    INT = 84, WS = 85, LINE_COMMENT = 86
  };
