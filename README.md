...
16. 快捷键 `ctrl + alt + h` 清除所有节点的颜色
### 删除节点
快捷键 `ctrl + /` 删除选中的节点     
快捷键 `ctrl + alt + /` 删除所有节点。bug：这个操作会留下一个节点，请重复使用两次以删除所有节点。
...
快捷键 `ctrl + .` 选择正则，并以选中的节点为始端进行二次搜索   
快捷键 `ctrl + ,` 选择正则，并以选中的节点为末端进行二次搜索    
