...
8. 快捷键 `ctrl + alt + v` 取消固定所有未选中的节点的位置
9. 快捷键 `w + +` 增加选中的节点所组成的子图的布局权重，权重越大，布局月紧凑
10. 快捷键 `w + -` 减少选中的节点所组成的子图的布局权重
11. 快捷键 `ctrl + alt + w` 恢复所有未选中的节点布局权重
12. 快捷键 `ctrl + j` 聚合选中的节点
13. 快捷键 `Shift + j` 取消聚合选中的节点
14. 快捷键 `ctrl + alt + j` 取消聚合所有未选中的节点
### 图样式(大小与颜色)
...
9. 快捷键 `i + +` 连线变粗
10. 快捷键 `i + -` 连线变细
11. 快捷键 `N + +` 选中的节点变的更不透明
12. 快捷键 `N + -` 选中的节点变的更透明
13. 快捷键 `M + +` 未选中的节点变的更不透明 
14. 快捷键 `M + -` 未选中的节点变的更透明 
15. 快捷键 `h` 给选中的节点选择颜色，会覆盖节点之前的颜色
16. 快捷键 `ctrl + h` 给所有节点自动上色，不会覆盖节点之前的颜色
17. 快捷键 `ctrl + alt + h` 清除所有未选中的节点的颜色
### 删除节点和边
快捷键 `ctrl + /` 删除选中的节点     
快捷键 `ctrl + alt + /` 删除所有未选中的节点。bug：这个操作会留下一个节点，请重复使用两次以删除所有节点。    
