...
8. 快捷键 `i + +` 连线变粗
9. 快捷键 `i + -` 连线变细
10. 快捷键 `N + +` 选中的节点变的更不透明
11. 快捷键 `N + -` 选中的节点变的更透明
12. 快捷键 `M + +` 未选中的节点变的更不透明 
13. 快捷键 `M + -` 未选中的节点变的更透明 
14. 快捷键 `h` 给选中的节点选择颜色，会覆盖节点之前的颜色
15. 快捷键 `ctrl + h` 给所有节点自动上色，不会覆盖节点之前的颜色
16. 快捷键 `ctrl + alt + h` 清除所有未选中的节点的颜色
### 删除节点
快捷键 `ctrl + /` 删除选中的节点     
