...
string FileManager::prologGlobalInfo_overrideMethodKey2TypeKey = prologBaseDir + "overrideMethodKey2TypeKey.pl";
...
string FileManager::prologGlobalInfo_filePath2overrideMethodKey2TypeKey = baseDataFolder + "filePath2overrideMethodKey2TypeKey.txt";
...
void FileManager::initCurrentDir() {
    ...
    prologGlobalInfo_overrideMethodKey2TypeKey = prologBaseDir + "overrideMethodKey2TypeKey.pl";
    ...
    prologGlobalInfo_filePath2overrideMethodKey2TypeKey = baseDataFolder + "filePath2overrideMethodKey2TypeKey.txt";
